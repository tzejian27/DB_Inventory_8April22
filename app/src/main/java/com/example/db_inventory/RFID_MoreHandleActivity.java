...
public class RFID_MoreHandleActivity extends Activity implements OnClickListener{
	...
	private RFID_UhfReaderDevice readerDevice;
	String epc = "";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.rfid_iso1800_6c);
		...
		if(readerDevice == null){
			Toast.makeText(getApplicationContext(), "UHF reader power on failed", Toast.LENGTH_SHORT).show();
			return ;
		}
