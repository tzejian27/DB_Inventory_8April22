...
public class Inventory_step4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        t1=(TextView)findViewById(R.id.textView_Inventory_TotalQty);
        t2=(TextView)findViewById(R.id.textView_Inventory_Qty);
        t3=(TextView)findViewById(R.id.textView_Inventory_name);
        t4=(TextView)findViewById(R.id.textView_Inventory_price);
        t5=(TextView)findViewById(R.id.textView_Inventory_cost);

        e1=(EditText)findViewById(R.id.editText_Inventory_barcode);

        b1=(Button)findViewById(R.id.btn_Inventory_esc);
        b2= (Button)findViewById(R.id.btn_Inventory_enter);
