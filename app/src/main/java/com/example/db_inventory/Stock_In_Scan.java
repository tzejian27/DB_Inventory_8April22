...
public class Stock_In_Scan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edt_barcode=(EditText)findViewById(R.id.editText_barcode_SI);
        btn_back=(Button)findViewById(R.id.btn_inventory_back_SI);
        btn_next=(Button)findViewById(R.id.btn_inventory_next_SI);
