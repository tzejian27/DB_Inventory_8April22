...
public class GRNList2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Good Returns No - Search List");
    ...
    public void onStart() {
        ...
        FirebaseRecyclerOptions<GoodReturnNo_class> GRN_Adapter = new FirebaseRecyclerOptions.Builder<GoodReturnNo_class>()
                .setQuery(GoodReturnsNo.orderByChild("customerCode").equalTo(goodReturnNo), GoodReturnNo_class.class)
                .setLifecycleOwner(this)
                .build();

        FirebaseRecyclerAdapter<GoodReturnNo_class, GRNList.GRNViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<GoodReturnNo_class, GRNList.GRNViewHolder>(GRN_Adapter) {
            @Override
            protected void onBindViewHolder(@NonNull GRNList.GRNViewHolder holder, @SuppressLint("RecyclerView") int position, @NonNull GoodReturnNo_class model) {
                ...
                holder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        AlertDialog.Builder builder = new AlertDialog.Builder(GRNList2.this);
                        ...
                        builder.setItems(option, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int i) {
                                ...
                                if (i == 1) {
                                    final AlertDialog.Builder warningDialog = new AlertDialog.Builder(GRNList2.this);
                                        ...
                                        public void onClick(DialogInterface dialog, int which) {
                                            InventoryGoodReturnsNo.child(model.getCustomerCode()).addListenerForSingleValueEvent(new ValueEventListener() {
                                                ...
                                                public void onDataChange(@NonNull DataSnapshot snapshot) {
                                                    if (snapshot.exists()) {
                                                        Toast.makeText(GRNList2.this, "This good return no is used , cannot be delete", Toast.LENGTH_SHORT).show();
                                                    }else{
                                                        GoodReturnsNo.child(model.getCustomerCode()).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                                                            @Override
                                                            public void onComplete(@NonNull Task<Void> task) {
                                                                if (task.isComplete()){
                                                                    Toast.makeText(GRNList2.this, "Deleted Successfully !", Toast.LENGTH_SHORT).show();
                                                                }
                                                            }
                                                        });
                                                    }
            ...
            @NonNull
            @Override
            public GRNList.GRNViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                //LINKING THE RECYCLE LAYOUT
                View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.sa_recycle, parent, false);
                return new GRNList.GRNViewHolder(view);
            }
        };
